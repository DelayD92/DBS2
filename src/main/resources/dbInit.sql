...
DECLARE
    PROCEDURE dropTable(tableName IN VARCHAR2) IS
        ...
        BEGIN
            ...
            EXCEPTION
            WHEN TABLE_DOES_NOT_EXISTS
            THEN NULL;
            -- WHEN OTHERS THEN -> Don't use this, to see if there is any other issue while dropping the tables
        END;
BEGIN
...
-- MovieCharacter
INSERT INTO MOVIECHARACTER (MOVCHARID, MOVIE, CHARACTER, ALIAS, POSITION)
...
-- PersonPlays
INSERT INTO PERSONPLAYS (PERSON, MOVIECHAR)
VALUES (1, 1);
INSERT INTO PERSONPLAYS (PERSON, MOVIECHAR)
VALUES (2, 2);
INSERT INTO PERSONPLAYS (PERSON, MOVIECHAR)
